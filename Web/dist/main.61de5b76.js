...
},{"./bundle-url":"C:\\Users\\LiuZX\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\bundle-url.js"}],"src\\assets\\css\\main.css":[function(require,module,exports) {

var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:\\Users\\LiuZX\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\css-loader.js"}],"src\\assets\\js\\socket.io.js":[function(require,module,exports) {
var define;
...
var _socket = require('./assets/js/socket.io');

var _socket2 = _interopRequireDefault(_socket);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var oEnter = document.getElementById('js-enter'); // 发送消息按钮
var oCount = document.getElementById('js-conut'); // 在线人数
var oCount2 = document.getElementById('js-conut2'); // 在线人数
var oLogin = document.getElementById('js-login'); // 登录弹窗
var oLoginBtn = document.getElementById('js-loginBtn'); // 登录按钮
var oOpenBton = document.getElementById('js-openBtn'); // 打开用户列表的按钮
var oBg = document.getElementById('js-bg'); // 遮罩
var oChatBox = document.getElementById('js-chatBox'); // 聊天窗口
//let socket = io('ws://chatapi.rxshc.com')                 // ws 链接
var socket = (0, _socket2.default)('ws://localhost:3001'); // ws 链接
var oMessageBox = document.getElementById('js-messageBox'); // 消息窗口
var oUserBox = document.getElementById('js-userList'); // 用户列表
var loginStatus = false; // 登录状态
var nickName = ''; // 当前登录用户名
...
function sendMessage() {
  var oText = document.getElementById('js-text');
  var sText = delHtmlTag(oText.value);
  if (sText === '') {
    alert('不能为空');
    return false;
...
// 登录
function userLogin() {
  var loginName = delHtmlTag(document.getElementById('js-loginName').value);
  if (loginName === '') {
    alert('你必须输入用户名');
...
},{"./assets/css/main.css":"src\\assets\\css\\main.css","./assets/js/socket.io":"src\\assets\\js\\socket.io.js"}],"C:\\Users\\LiuZX\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:\\Users\\LiuZX\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js","src\\main.js"], null)
//# sourceMappingURL=/main.61de5b76.map